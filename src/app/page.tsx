...
type View = "solver" | "market" | "experiment" | "real" | "capacity" | "willingness" | "participant" | "operator" | "marketplace";
    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      {status === "loading" ? (
        ...
        <>
          ...
          {view === "solver" ? <OryxConsole /> : view === "market" ? <div className="mx-auto w-full max-w-6xl px-4 py-6"><MarketSimulator /></div> : view === "experiment" ? <div className="mx-auto w-full max-w-6xl px-4 py-6"><ExperimentLab /></div> : view === "real" ? <div className="mx-auto w-full max-w-6xl px-4 py-6"><RealLab /></div> : view === "capacity" ? <div className="mx-auto w-full max-w-6xl px-4 py-6"><CapacityLab /></div> : view === "willingness" ? <div className="mx-auto w-full max-w-6xl px-4 py-6"><WillingnessLab /></div> : view === "participant" ? <div className="mx-auto w-full max-w-3xl px-4 py-6"><ProviderResearchUI /></div> : view === "operator" ? <div className="mx-auto w-full max-w-6xl px-4 py-6"><ResearchOperatorDashboard /></div> : <div className="mx-auto w-full max-w-6xl px-4 py-6"><MarketplaceConsole /></div>}
        </>
      ) : (
