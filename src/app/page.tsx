      ...
      switch (offer.kind) {
        ...
        case "wait_watch": {
          toast({
            ...
            description: `ORYXX will alert if a plan drops to ~$${offer.deltaCost ? (lastEvent ? 0 : 0) : 0}. Open the live feed below.`,
          });
          return;
        }
      }
        ...
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4">
          ...
          <nav className="flex items-center gap-1">
            <Button variant="ghost" size="sm" className="hidden text-xs sm:flex" asChild>
              <a href="#thesis">
                <Radar className="mr-1 h-3.5 w-3.5" /> Thesis
              </a>
            </Button>
            <Button variant="ghost" size="sm" className="hidden text-xs sm:flex" asChild>
              <a href="#architecture">
                <Layers className="mr-1 h-3.5 w-3.5" /> Architecture
              </a>
            </Button>
